...
declare global {
  interface Window {
    ...
    _caduceusInitialised?: boolean
    _caduceusNavInitialised?: boolean
    _caduceusInboxRefresh?: () => void
    _caduceusShowToast?: (msg: string | { msg: string; duration?: number; action?: { label: string; onClick: () => void } }, duration?: number) => void
    _caduceusKeyboard?: {
      init: () => Promise<void>
      destroy: () => void
    }
