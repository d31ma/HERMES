// Compile HERMES to a standalone binary.
...
//
// The output binary bundles Bun runtime + tachyon + HERMES.
...
// The tachyon compiler will not pick up test routes since they're behind HERMES_ENABLE_TEST_ROUTES
...
console.log(`Compiled HERMES binary for ${target}`)
console.log(`Output: dist-bin/hermes`)
...
console.log(`Binary: hermes-${target}`)
