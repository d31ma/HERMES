/**
 * CADUCEUS on DigitalOcean DOKS (Kubernetes).
 *
 * Provisions: Kubernetes Deployment (1 replica), ClusterIP Service,
 * DO Block Storage PVC for /data, and an Ingress with cert-manager
 * for HTTPS. Uses the DOKS cluster from kubeconfig.
 *
 * Prerequisites:
 *   - An existing DOKS cluster (provision via DO console or Pulumi)
 *   - cert-manager installed on the cluster
 *   - doctl configured and kubeconfig pointing to the cluster
 *
 * Usage:
 *   cd examples/digitalocean/kubernetes
